...
# আপনার API Key বসান
GEMINI_API_KEY = "AQ.Ab8RN6JLhFtsbl7GNCsPGQS1BO-_XrvgezY75dosOBXpXJk9Qg"

# Google GenAI Client কনফিগারেশন
...
def analyze_plant_health(image):
  ...
  # ১. ছবির রেজুলেশন কমিয়ে আপলোড ও প্রসেসিং স্পিড ৩ গুণ বাড়ানো
  ...
  try:
    # ২. দ্রুতগতির 'gemini-2.5-flash' বা 'gemini-1.5-flash' মডেল এবং Streaming ব্যবহার
...
interface = gr.Interface(
    ...
    description=(
        "আক্রান্ত পাতা, ফুল বা ফলের ছবি তুলুন অথবা আপলোড করুন। এআই সাথে সাথেই"
        " রোগের কারণ ও সমাধান জানিয়ে দেবে।"
    ),
)
